...
plugins=(extract git brew osx sublime z matlab autoenv zsh-syntax-highlighting)
...
# plugins, and thes. Aliases can be placed here, though oh-my-zsh
...
# Matlab alias
# alias matlab='/usr/local/MATLAB/R2016a/bin/matlab -desktop'
